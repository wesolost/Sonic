...
const uint16_t BUTTON_PIN_SOURCE[BUTTONn] = {USER_BUTTON_EXTI_PIN_SOURCE0,USER_BUTTON_EXTI_PIN_SOURCE1};

const uint16_t BUTTON_PORT_SOURCE[BUTTONn] = {USER_BUTTON_EXTI_PORT_SOURCE0,USER_BUTTON_EXTI_PORT_SOURCE1};

GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {USER_BUTTON_GPIO_PORT0,USER_BUTTON_GPIO_PORT1}; 

const uint16_t BUTTON_PIN[BUTTONn] = {USER_BUTTON_PIN0,USER_BUTTON_PIN1}; 

const uint32_t BUTTON_CLK[BUTTONn] = {USER_BUTTON_GPIO_CLK0,USER_BUTTON_GPIO_CLK1};

const uint16_t BUTTON_EXTI_LINE[BUTTONn] = {USER_BUTTON_EXTI_LINE0,USER_BUTTON_EXTI_LINE1};

const uint16_t BUTTON_IRQn[BUTTONn] = {USER_BUTTON_EXTI_IRQn0,USER_BUTTON_EXTI_IRQn1};

const uint16_t BUTTON_PIN_MODE[BUTTONn] = {USER_BUTTON_PIN_MODE0,USER_BUTTON_PIN_MODE1};	

const uint16_t BUTTON_TRIGER_MODE[BUTTONn] = {USER_BUTTON_TRIGER_MODE0,USER_BUTTON_TRIGER_MODE1};	
...
void STM32vldiscovery_PBInit(Button_TypeDef Button, ButtonMode_TypeDef Button_Mode)
{
  ...
  GPIO_InitStructure.GPIO_Mode = BUTTON_PIN_MODE[Button];
  ...
  if (Button_Mode == BUTTON_MODE_EXTI)
  {
    ...
    EXTI_InitStructure.EXTI_Trigger = BUTTON_TRIGER_MODE[Button];  
